...
export const translations = {
    ...
    llm_evaluation: { pl: "Ocena sędziego AI", en: "AI Judge's Evaluation" },
    evaluation_text: { pl: "{evaluation} (Prawdopodobieństwo błędu gracza: {probability}%)", en: "{evaluation} (Player Error Probability: {probability}%)" },
