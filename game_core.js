...
// Tłumaczenia zostały rozszerzone o nowe klucze dla dodanych funkcji
const translations = {
    ...
    category_mutation_prompt: {
        pl: `Jesteś kreatywnym mistrzem gry. Kategoria "{old_category}" została opanowana. Twoim zadaniem jest wygenerowanie TRZECH propozycji nowych, powiązanych tematycznie, ale wyraźnie różnych kategorii. Unikaj prostych synonimów. ID sesji: {random_id}. Zwróć TYLKO i WYŁĄCZNIE obiekt JSON w formacie {"choices": ["Propozycja 1", "Propozycja 2", "Propozycja 3"]}. Nie dodawaj żadnych innych słów ani formatowania markdown.`,
        en: `You are a creative game master. The category "{old_category}" has been mastered. Your task is to generate THREE new, thematically related, but distinctly different category proposals. Avoid simple synonyms. Session ID: {random_id}. Return ONLY and EXCLUSIVELY a JSON object in the format {"choices": ["Proposal 1", "Proposal 2", "Proposal 3"]}. Do not add any other words or markdown formatting.`
    },
